...
for i in range(1, 4):
    for index, row in bench_df.iterrows():
        ...
        if len(proy_data) > 0:
            row_proyection["CostoFijo_HaDia_Proyeccion"] = proy_data[
                "costo_fijo_ha_dia"
            ][0]
            ...
            row_proyection["UltimoAlimentoAcumuladoKg"] = proy_data[
                "alimento_acumulado"
            ][0]
...
acertividad_df["DensidadFinal_Im2_Proyeccion"] = acertividad_df[
    "DensidadSiembra_Im2"
] * (acertividad_df["SobPesca_Proyeccion"] / 100)
...
acertividad_df["PrecisionFCA"] = np.vectorize(calculate_mape, otypes=[np.float64])(
    acertividad_df["FCA"], acertividad_df["FCA_Proyeccion"]
)
acertividad_df["PrecisionPesoPesca"] = np.vectorize(
    calculate_mape, otypes=[np.float64]
)(acertividad_df["PesoPesca"], acertividad_df["PesoPescaProyeccion"])
acertividad_df["PrecisionSobPesca"] = np.vectorize(calculate_mape, otypes=[np.float64])(
    acertividad_df["SobPesca"], acertividad_df["SobPesca_Proyeccion"]
)
acertividad_df["PrecisionAlimentoAcumuladoKg"] = np.vectorize(
    calculate_mape, otypes=[np.float64]
)(
    acertividad_df["AlimentoAcumuladoKg"],
    acertividad_df["AlimentoAcumuladoKg_Proyeccion"],
)
acertividad_df["PrecisionDensidadFinal_Im2"] = np.vectorize(
    calculate_mape, otypes=[np.float64]
)(acertividad_df["DensidadFinal_Im2"], acertividad_df["DensidadFinal_Im2_Proyeccion"])
acertividad_df["PrecisionCostoFijo_HaDia"] = np.vectorize(
    calculate_mape, otypes=[np.float64]
)(acertividad_df["CostoFijo_HaDia"], acertividad_df["CostoFijo_HaDia_Proyeccion"])
acertividad_df["PrecisionPrecioMixAlimento"] = np.vectorize(
    calculate_mape, otypes=[np.float64]
)(acertividad_df["PrecioMixAlimento"], acertividad_df["PrecioMixAlimento_Proyeccion"])
acertividad_df["PrecisionPrecioLarva"] = np.vectorize(
    calculate_mape, otypes=[np.float64]
)(acertividad_df["PrecioLarva"], acertividad_df["PrecioLarva_Proyeccion"])
acertividad_df["PrecisionCostoLbCamaron"] = np.vectorize(
    calculate_mape, otypes=[np.float64]
)(acertividad_df["CostoLbCamaron"], acertividad_df["CostoLbCamaron_Proyeccion"])
acertividad_df["PrecisionUP_HaDia"] = np.vectorize(calculate_mape, otypes=[np.float64])(
    acertividad_df["UP_HaDia"], acertividad_df["UP_HaDia_Proyeccion"]
)
acertividad_df["PrecisionPrecioCamaronPesca"] = np.vectorize(
    calculate_mape, otypes=[np.float64]
)(acertividad_df["PrecioCamaronPesca"], acertividad_df["PrecioCamaronPesca_Proyeccion"])
acertividad_df["PrecisionBiomasaPescaLbHa"] = np.vectorize(
    calculate_mape, otypes=[np.float64]
)(acertividad_df["BiomasaPescaLbHa"], acertividad_df["BiomasaPescaLbHa_Proyeccion"])
